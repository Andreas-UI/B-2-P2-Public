(function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
        ...
        var UPLOAD_URL_ATTRIBUTE = "data-pawn-upload-urls-path",
            PROCESSING_URL_ATTRIBUTE = "data-pawn-urls-path",
            RESIZABILITY_ATTRIBUTE = "data-pawn-editor-resizable",
            LATENCY_ATTRIBUTE = "data-pawn-latency",
            LATENCY_MINIMUM = 500,
        ...
        var pawn = function (parent, editor, preview) {
            ...
            // custom input image
            document.querySelector('.pawn-i-image-upload').onchange = (event) => {
                if (event.target.files && event.target.files.length) {
                    return sendFile(event.target.files[0])
                }
            }
        ...
        docReady(function () {
            ...
            return Object.keys(ELEMENTS).map(function (key) {
                var element = ELEMENTS[key],
                    editor = element.querySelector(".pawn-editor"),
                    preview = element.querySelector(".pawn-preview");
