(function e(t, n, r) {
    ...
    1: [ function(require, module, exports) {
        ...
        var UPLOAD_URL_ATTRIBUTE = "data-pawn-upload-urls-path", PROCESSING_URL_ATTRIBUTE = "data-pawn-urls-path", RESIZABILITY_ATTRIBUTE = "data-pawn-editor-resizable", LATENCY_ATTRIBUTE = "data-pawn-latency", LATENCY_MINIMUM = 500, XHR_RESPONSE_ERROR = "Invalid response", UPLOAD_START_OPACITY = "0.3", NORMAL_OPACITY = "1";
        var EventHandlers = {
        ...
        var pawn = function(parent, editor, preview) {
            var _this = this;
            var properties = {
                editor: editor,
                preview: preview,
            ...
            var _initialize = function() {
                ...
                properties.editor.setAttribute("data-pawn-init", "");
                ...
                getMarkdown();
                utils_1.triggerCustomEvent("pawn.init");
            };
            ...
            var sendFile = function(file) {
                ...
                xhr.success = function(resp) {
                    ...
                    if (response.image_code) {
                        ...
                        utils_1.triggerCustomEvent("pawn.fileUploadEnd", properties.parent, [ response ]);
                    } else if (response.image_path) {
                        insertImage('![]("' + response.image_path + '")');
                        utils_1.triggerCustomEvent("pawn.fileUploadEnd", properties.parent, [ response ]);
                    } else {
                        console.error(XHR_RESPONSE_ERROR, response);
                        utils_1.triggerCustomEvent("pawn.fileUploadError", properties.parent, [ response ]);
            ...
            var getMarkdown = function() {
                ...
                xhr.success = function(response) {
                    ...
                    utils_1.triggerCustomEvent("pawn.update", properties.parent, [ response ]);
                };
                xhr.error = function(response) {
                    console.error(response);
                    utils_1.triggerCustomEvent("pawn.updateError", properties.parent, [ response ]);
                };
                return xhr.send();
            };
        ...
        docReady(function() {
            var ELEMENTS = document.getElementsByClassName("pawn");
            return Object.keys(ELEMENTS).map(function(key) {
                var element = ELEMENTS[key], editor = element.querySelector(".pawn-editor"), preview = element.querySelector(".pawn-preview");
                if (!editor.hasAttribute("data-pawn-init")) return new pawn(element, editor, preview);
            });
        });
    }, {
        "./utils": 2
